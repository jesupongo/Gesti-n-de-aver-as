...
console.log("SURGERY: V4 ULTIMATE...");
...
const ne_content = `function ne({navegar:e,rol_u:t,nom_u:n,id_u:id_u,up:r}){
...
const ie_content = `function ie({navegar:e,rol_u:t}){
...
let end_of_ie = content.indexOf('function ae({');
content = content.substring(0, ne_start) + ne_content + content.substring(ie_start, ie_start) + ie_content + content.substring(end_of_ie);
