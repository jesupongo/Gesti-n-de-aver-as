...
console.log("Applying SCOPE SAFETY FIX...");
...
// 2. Component Signatures with UNIQUE prop names to avoid shadowing
// rolUsuario:rol_u, nombreUsuario:nom_u, idUsuario:id_u
content = content.replace('function C({navegar:e})', 'function C({navegar:e,idUsuario:id_u})');
content = content.replace('function ae({navegar:e,rolUsuario:t,nombreUsuario:n,actualizarPerfil:r})', 'function ae({navegar:e,rolUsuario:rol_u,nombreUsuario:nom_u,idUsuario:id_u,actualizarPerfil:r})');
content = content.replace('function ne({navegar:e,rolUsuario:t,nombreUsuario:n,actualizarPerfil:r})', 'function ne({navegar:e,rolUsuario:rol_u,nombreUsuario:nom_u,idUsuario:id_u,actualizarPerfil:r})');

// Update App calls to use these components
...
// 5. ne Filter bypass for admin using rol_u (Shadowing-safe)
content = content.replace('return n&&r&&i&&a', 'return rol_u=="admin" ? n&&r&&i&&a : n&&r&&i&&a&&(e.asignadoA==id_u&&e.verificada)');

// 6. REAL POST Replacement (Using 800 and 600 timing strings)
...
// 7. UI Locks & Admin Button (Using rol_u)
...
console.log("SCOPE SAFETY FIX COMPLETED.");
