...
console.log("SURGERY: FINAL OBLITERATION...");

// 1. IDENTITY & PERSISTENCE (App)
...
// 2. COMPONENT CALLS
content = content.replace('e===`panel-admin`&&(0,x.jsx)(ne,{navegar:o,rolUsuario:n,nombreUsuario:i,actualizarPerfil:a})', 'e===`panel-admin`&&(0,x.jsx)(ne,{navegar:o,r_u:n,n_u:i,u_i:u,up:a_s})');
content = content.replace('e===`panel-personal`&&(0,x.jsx)(ae,{navegar:o,rolUsuario:n,nombreUsuario:i,actualizarPerfil:a})', 'e===`panel-personal`&&(0,x.jsx)(ae,{navegar:o,r_u:n,n_u:i,u_i:u,up:a_s})');
content = content.replace('e===`usuarios-averias`&&(0,x.jsx)(ie,{navegar:o,rolUsuario:n})', 'e===`usuarios-averias`&&(0,x.jsx)(ie,{navegar:o,r_u:n})');

// 3. VISTA ADMIN (ne) - COMPLETE BLOCK REPLACEMENT
let ne_start = content.indexOf('function ne({');
let ie_start = content.indexOf('function ie({');

const ne_new = `function ne({navegar:e,r_u:t,n_u:n,u_i:id_u,up:r}){
...
content = content.substring(0, ne_start) + ne_new + content.substring(ie_start);

fs.writeFileSync(path, content);
console.log("FINAL OBLITERATION COMPLETED.");
